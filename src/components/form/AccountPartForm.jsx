...
import { formatUntilDate, formatDisplayValue } from '@/utils/formatHelpers'
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex flex-row items-center py-2">
                ...
                <h2 className="text-sm font-semibold text-gray-800 w-5/6">{formatUntilDate(accountPartData.regist_date)}</h2>
            </div>
