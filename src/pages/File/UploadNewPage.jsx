    ...
    return (
        <div className="container mx-auto">
            ...
            <form className="bg-white p-5 rounded-xl space-y-6" onSubmit={handleSubmit}>
                ...
                {/* ✅ 포함된 파일 */}
                <div className="grid grid-cols-6 items-center space-x-4">
                    <label htmlFor="include_files" className="col-span-2 text-sm font-medium text-gray-900">포함된 파일 (',' 구분)</label>
                    <input type="text" id="include_files" name="include_files" value={formData.include_files.join(', ')}
                           onChange={handleFileChange} className="col-span-4 border p-2.5 rounded-lg" placeholder="CDRv3.csv, NetworkReport.csv" />
                </div>
