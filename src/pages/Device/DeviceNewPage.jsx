                ...
                <form className="bg-white p-5 rounded-xl space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="grid grid-cols-6 items-center space-x-4">
                        ...
                        <label htmlFor="serial_number"
                               className="col-start-1 col-end-1 text-sm font-medium text-gray-900">
                            단말기 <span className="text-red-500">*</span>
                        </label>
                        {/* ✅ 2~3번째 칸 (Input) */}
                        <input
                            type="text"
                    ...
                    <div className="grid grid-cols-6 items-center space-x-4">
                        <label htmlFor="acct_num" className="col-start-1 col-end-1 text-sm font-medium text-gray-900">
                            고객 번호 <span className="text-red-500">*</span>
                        </label>
                        <input
                            type="text"
                            id="acct_num"
                    ...
                    <div className="grid grid-cols-6 items-center space-x-4">
                        <label htmlFor="ppid" className="col-start-1 col-end-1 text-sm font-medium text-gray-900">
                            PPID <span className="text-red-500">*</span>
                        </label>
                        <input
                            type="number"
                            id="ppid"
                    ...
                    <div className="grid grid-cols-6 items-center space-x-4">
                        <label htmlFor="activated" className="col-start-1 col-end-1 text-sm font-medium text-gray-900">
                            활성화 날짜 <span className="text-red-500">*</span>
                        </label>
                        <input
                            type="date"
                            id="activated"
